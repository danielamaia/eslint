...
const fs = require("fs"),
    ...
    { CascadingConfigArrayFactory } = require("./cascading-config-array-factory"),
    { getUsedExtractedConfigs } = require("./config-array"),
    { FileEnumerator } = require("./file-enumerator"),
    ConfigOps = require("../config/config-ops"),
    LintResultCache = require("./lint-result-cache"),
    hash = require("./hash"),
        ...
        if (typeof resolvedFormatName === "string") {
            ...
            if (!namespace && normalizedFormatName.indexOf("/") > -1) {
                ...
                try {
                    ...
                    formatterPath = ModuleResolver.resolve(npmFormat, path.join(cwd, ".eslintrc"));
                } catch (e) {
