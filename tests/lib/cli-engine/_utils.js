 ...
 * @returns {{ fs: import("fs"), ConfigArrayFactory: import("../../../lib/cli-engine/config-array-factory")["ConfigArrayFactory"] }} The stubbed `ConfigArrayFactory` class.
 */
function defineConfigArrayFactoryWithInmemoryFileSystem({
    ...
    stubs["../util/module-resolver"] = { resolve: fsResolve.bind(null, fs) };
 ...
 * @param {() => string} [options.cwd] The current working directory.
 * @param {Object} [options.files] The initial files definition in the in-memory file system.
 * @returns {{ fs: import("fs"), CascadingConfigArrayFactory: import("../../../lib/cli-engine/cascading-config-array-factory")["CascadingConfigArrayFactory"], ConfigArrayFactory: import("../../../lib/cli-engine/config-array-factory")["ConfigArrayFactory"] }} The stubbed `FileEnumerator` class.
 */
 ...
 * @param {() => string} [options.cwd] The current working directory.
 * @param {Object} [options.files] The initial files definition in the in-memory file system.
 * @returns {{ fs: import("fs"), FileEnumerator: import("../../../lib/cli-engine/file-enumerator")["FileEnumerator"], IgnoredPaths: import("../../../lib/cli-engine/ignored-paths")["IgnoredPaths"], CascadingConfigArrayFactory: import("../../../lib/cli-engine/cascading-config-array-factory")["CascadingConfigArrayFactory"], ConfigArrayFactory: import("../../../lib/cli-engine/config-array-factory")["ConfigArrayFactory"] }} The stubbed `FileEnumerator` class.
 */
function defineFileEnumeratorWithInmemoryFileSystem({
    cwd = process.cwd,
    files = {}
} = {}) {
    const { fs, CascadingConfigArrayFactory, ConfigArrayFactory } =
